...
public class Constant {
	...
	public static final String API_POST = "http://www.inlistdev.com/";
	...
	public static class ACTIONS {
		...
		// "credit_card/save/?apiMode=VIP&json=true&user_card_id=%s&card_type=%s&card_number=%s&card_name=%s&card_exp_year=%s&card_exp_month=%s&set_default=1";
	...
	public static class TAGS {
		...
		public static final String CARD_EXP_DATE = "card_exp_year";
		public static final String CARD_EXP_MONTH = "card_exp_month";
		public static final String CARD_SET_DEFAULT = "1";

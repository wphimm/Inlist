...
public class PullToRefreshLayout extends FrameLayout {
	...
	public interface OnHeaderClickListener {
		void onHeaderClick(PullToRefreshLayout l, View header,
	...
	public interface OnStickyHeaderOffsetChangedListener {
		 ...
		 *            of the screen.
		 */
		void onStickyHeaderOffsetChanged(PullToRefreshLayout l, View header,
				int offset);
	}
	...
	public interface OnStickyHeaderChangedListener {
		 ...
		 */
		void onStickyHeaderChanged(PullToRefreshLayout l, View header,
			...
			mHeader.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					mOnHeaderClickListener.onHeaderClick(
							PullToRefreshLayout.this, mHeader, mHeaderPosition,
							mHeaderId, true);
				}
			});
		}
	...
	private class AdapterWrapperHeaderClickHandler implements
		...
		public void onHeaderClick(View header, int itemPosition, long headerId) {
			mOnHeaderClickListener.onHeaderClick(PullToRefreshLayout.this,
					header, itemPosition, headerId, false);
		}
			...
			if (mOnHeaderClickListener != null) {
				...
				if (mHeader != null) {
					mHeader.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							mOnHeaderClickListener.onHeaderClick(
									PullToRefreshLayout.this, mHeader,
	...
	public void setAdapter(StickyListHeadersAdapter adapter) {
		...
		if (adapter instanceof SectionIndexer) {
			// mAdapter = new SectionIndexerAdapterWrapper(getContext(),
			// adapter);
			mAdapter = new SectionIndexerAdapterWrapper(getContext(), mAdapter);
		} else {
			mAdapter = new AdapterWrapper(getContext(), mAdapter);
		}
	...
	public StickyListHeadersAdapter getAdapter() {
		return (StickyListHeadersAdapter) (mAdapter == null ? null
				: mAdapter.mDelegate);
	}
		...
		if (l != null) {
			mList.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					return l.onTouch(PullToRefreshLayout.this, event);
				}
			});
		} else {
